...
import { Target, Headphones, Mic, Trophy, Flame, ChevronRight, MessageSquare, ListTodo } from "lucide-react";
import { storage, UserProfile } from "../lib/storage";

export default function Dashboard() {
  const navigate = useNavigate();
  const [profile, setProfile] = useState<UserProfile>({ level: "B1", plan: [], feedback: null });
    ...
    <div className="flex-1 p-6 max-w-5xl w-full mx-auto">
        ...
        <div className="lg:col-span-2 glass-panel rounded-3xl p-8 relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <div className="w-full bg-zinc-900 rounded-full h-3 mb-3 border border-zinc-800">
              <div className="bg-gradient-to-r from-violet-500 to-blue-500 h-3 rounded-full shadow-[0_0_10px_rgba(139,92,246,0.5)]" style={{ width: "45%" }} />
            </div>
            <p className="text-sm text-zinc-400 font-medium">45% to reach {nextLevel}</p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
        ...
        >
          ...
          <p className="text-zinc-400 mb-6 leading-relaxed">Listen to native sentences and repeat them. Get instant AI feedback on your pronunciation.</p>
        ...
        >
          ...
          <p className="text-zinc-400 mb-6 leading-relaxed">Talk naturally with EchoCoach using your voice. Get grammar corrections and practice fluency.</p>
